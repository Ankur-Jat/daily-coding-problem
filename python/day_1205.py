...
"""
Solution:
Create a new LinkedList and keep iterating over the given two LLs and use 
their node sum as the value of the node this new LL
"""
...
def test():
    ...
    for i in range(3):
        if not l3 or l3.val != result[i]:
            print("Test case failed at index: ", i, l3.val)
            break
        l3 = l3.next
